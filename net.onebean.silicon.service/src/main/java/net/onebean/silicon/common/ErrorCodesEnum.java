...
public enum ErrorCodesEnum {
    ...
    SIGN_ERROR("xxxx010002","签名校验异常"),
    TIME_STAMP_ERROR("xxxx010003","过时的请求"),
    //02
    NONE_QUERY_DATA("xxxx020001","没有对应的数据"),
    //03
    CACHE_DATA_ERR("xxxx030001","缓存数据异常"),
    //05
    READ_VALUE_FROM_APOLLO("xxxx050001","从配置中心获取信息失败"),
    CLOUD_API_ERR("xxxx050002","从接口获取数据异常"),
    UPLOAD_IMAGE_API_ACCESS_ERR("xxxx050003","上传图片接口访问失败"),
    UPLOAD_IMAGE_FAILURE("xxxx050004","上传图片到服务器操作失败"),
    //07
    JSON_CAST_ERROR("xxxx070001","序列化JSON异常"),
    REF_ERROR("xxxx070002","反射属性异常"),
    //99
